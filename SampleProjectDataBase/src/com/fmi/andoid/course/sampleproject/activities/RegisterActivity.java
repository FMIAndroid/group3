...
import com.fmi.android.course.sampleproject.utils.Constanst;
import com.fmi.android.course.sampleproject.utils.User;
import com.fmi.android.course.sampleproject.utils.UsersStorage;
...
public class RegisterActivity extends Activity {
	...
	private Boolean saveCredentials() {
		...
		try {
			Log.d("DEBUG", "save user : " + DBManager.getInstance().saveUser(user));
		} catch (Exception e) {
